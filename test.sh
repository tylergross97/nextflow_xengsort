#!/bin/bash
#SBATCH --job-name="nextflow_xengsort_test"
...
#SBATCH --mem=126G
#SBATCH --time=0:50:00
#SBATCH --output=/projects/academic/rpili/Jonathan_Lovell_project/nextflow_xengsort/slurm/slurm-%j.out
#SBATCH --error=/projects/academic/rpili/Jonathan_Lovell_project/nextflow_xengsort/slurm/slurm-%j.err
...
export NXF_WORK=/vscratch/grp-rpili/neoantigen_prediction/xengsort/test
