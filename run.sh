...
#SBATCH --output=/projects/academic/rpili/pure_pdx/slurm/slurm-%j.out
#SBATCH --error=/projects/academic/rpili/pure_pdx/slurm/slurm-%j.err
...
export NXF_WORK=/vscratch/grp-rpili/pdx_purity/diet_invivo_2023
...
nextflow run main.nf \
    --input /projects/academic/rpili/sabrina_tyler_collab/data/samplesheets/rnaseq_samplesheet.csv \
    --outdir_base /projects/academic/rpili/pure_pdx/results/ccrcc/diet_invivo_2023 \
    --hg38_fasta /projects/academic/rpili/scripts/GRCh38.primary_assembly.genome.fa \
    --hg38_gtf /projects/academic/rpili/scripts/gencode.v47.basic.annotation.gtf \
    --nsg_fasta /projects/academic/rpili/pdx_pipeline_test/nsgReference/mm10.nsgSpike.fa \
    --nsg_gtf /projects/academic/rpili/pdx_pipeline_test/nsgReference/gencode.vM10.annotation.gtf \
    -profile singularity \
    -resume
